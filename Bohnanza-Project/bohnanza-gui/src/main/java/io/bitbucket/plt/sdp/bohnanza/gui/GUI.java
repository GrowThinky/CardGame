...
public class GUI {
    ...
    public GUI(Size initialWindowSize, Size cardSize, Size zoomedCardSize, Color background, Color foreground) {
        ...
        // Create a child composite to old the controls
        ...
        canvas.addListener(SWT.Paint, e -> {
            synchronized (GUI.this) {
                if (redrawNeeded || offScreen != null) {
                    ...
                    if (shell.getClientArea().width > bounds.width) {
                    	bounds.width = shell.getClientArea().width; 
                    }
                    if (shell.getClientArea().height > bounds.height) {
                    	bounds.height = shell.getClientArea().height; 
                    }
    ...
    /**
     * Removes a label from the GUI.
     * 
     * @param label the label to remove. May not be null
     * @return
     */
     ...
     * @param button the button to remove. May not be null.
     */
